            ...
            <b-row>
                <b-col cols="12" :key="index" v-for="(item,index) in arrsTest">
                    <b-form-group label-cols="4" label-cols-lg="3" :label="$t('HOME.'+item.label) +':'">
                        ...
                        <b-form-input @change="changeFunc2(item.customItem, index)" v-model="item.customItem"
                        ...
                        <b-form-radio-group v-if="item.type==='radio'" name="radio-sub-component">
                            ...
                            <input type="radio" id="one" value="male" @change="changeFunc2(item.customItem, index)"
                                   v-model="item.customItem">
                            <label for="one" class="radio-label-sty">{{ $t('HOME.Male') }}</label>
                            <input type="radio" id="two" value="female" @change="changeFunc2(item.customItem, index)"
                                   v-model="item.customItem">
                            <label for="two" class="radio-label-sty">{{ $t('HOME.Female') }}</label>
                        </b-form-radio-group>

                        <b-form-datepicker @context="changeFunc2(item.customItem, index)" v-model="item.customItem"
